        ...
        child: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: Container(
                child: NavBarButton(imageName: "assets/navbar_track2.png",displayName: "1",isSelected: isSelected[0]),
              ),
              label: ''
            ),
            BottomNavigationBarItem(
              icon: Container(
                child: NavBarButton(imageName: "assets/navbar_trip.png",displayName: "2",isSelected: isSelected[1]),
              ),
              label: ''
            ),
            BottomNavigationBarItem(
                icon: Container(
                  child: NavBarButton(imageName: "assets/navbar_notification.png",displayName: "3",isSelected: isSelected[2]),
                ),
                label: ''
            ),
            BottomNavigationBarItem(
                icon: Container(
                  child: NavBarButton(imageName: "assets/navbar_user.png",displayName: "4",isSelected: isSelected[3]),
                ),
                label: ''
            ),
          ],
