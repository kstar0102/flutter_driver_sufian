...
class TripDialogDetail extends StatefulWidget {
  ...
  const TripDialogDetail({Key? key, required this.trip_name, required this.origin_city, required this.origin_area, required this.dest_city, required this.dest_area}) : super(key: key);
