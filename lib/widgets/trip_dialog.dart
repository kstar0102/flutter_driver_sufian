...
class TripDialog extends StatefulWidget {
  ...
  const TripDialog({Key? key, required this.driver_name, required this.trip_name, required this.origin_city, required this.origin_area, required this.dest_city, required this.dest_area, required this.latitude, required this.longitude}) : super(key: key);
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, "/trip_track", arguments: [widget.trip_name, widget.origin_city, widget.origin_area, widget.dest_city, widget.dest_area, widget.latitude, widget.longitude]);
                    },
                    child: Container(
                      width: 120,
                      height: 25,
                      ...
                      child: Row(
                        ...
                        children: [
                          // SizedBox(width: 10,),
                          Image.asset("assets/navbar_track2.png", width: 15, height: 15,),
                          SizedBox(width: 10,),
                          const Text(
                            "TRIP TRACKING",
                            style: TextStyle(
